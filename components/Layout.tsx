...
const Layout: React.FC<LayoutProps> = ({ children, activeView, onViewChange }) => {
  ...
  const menuItems = [
    ...
    { id: 'returns', label: 'Monthly Returns', icon: Icons.Analytics },
    { id: 'royalty', label: 'Royalty Calc', icon: Icons.Calculator },
    { id: 'ratings', label: 'Rating Calculator', icon: Icons.Star },
    { id: 'star', label: 'Star Rating', icon: Icons.Star },
    { id: 'consultancy', label: 'Consultancy', icon: Icons.Consultancy },
