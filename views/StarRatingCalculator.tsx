    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      <div>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
          <div>
            <h2 className="text-2xl font-bold">Lessee Profile and Star Rating for Minor MInerals</h2>
            <p className="text-gray-500">Evaluation template for Star Rating of Mining Lease of Minor Minerals as per notification no 531 dated 23.04.2020 issued by Deparment of mines and geology , Government of Jharkhand</p>
          </div>
