    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">Stored Mineral (Start) (1)</label>
            <input type="number" name="storedStart" value={formData.storedStart} onChange={handleChange} step="0.01"
              className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent" />
          </div>

          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">Mined/Production (2)</label>
          ...
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">Domestic Use (4)</label>
            <input type="number" name="domesticUse" value={formData.domesticUse} onChange={handleChange} step="0.01"
              className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent" />
          </div>

          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">Dispatch Train (5)</label>
            <input type="number" name="dispatchTrain1" value={formData.dispatchTrain1} onChange={handleChange} step="0.01"
              className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent" />
          </div>

          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">Dispatch Truck (6)</label>
            <input type="number" name="dispatchTrain2" value={formData.dispatchTrain2} onChange={handleChange} step="0.01"
              className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent" />
          </div>

          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">Dispatch through others (7)</label>
          ...
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">Mineral Left (12) = (3)-(8)</label>
